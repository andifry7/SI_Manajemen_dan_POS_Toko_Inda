...
$title = "Laporan Penjualan - Toko Inda POS";
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?= $main_url ?>laporan-penjualan/index.php">Laporan Penjualan</a></li>
                        ...
                        <tbody>
                            ...
                            foreach ($penjualan as $jual) { ?>
                                <tr>
                                    ...
                                    <td><?= $jual['nama_brg'] ?></td>
                                    <td><?= $jual['kategori'] ?></td>
                                    <td class="text-right"><?= number_format($jual['harga_jual'], 0, ',', '.') ?></td>
                                    <td class="text-center"><?= $jual['qty'] ?></td>
                                    <td class="text-right"><?= number_format($jual['jml_harga'], 0, ',', '.') ?></td>
                                </tr>
                            <?php
                            }
                            ?>

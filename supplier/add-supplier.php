...
$title = "Tambah Supplier - Toko Inda POS";
        ...
        <div class="card">
            <form action="" method="post">
                <div class="card-header">
                    <h3 class="card-title"><i class="fas fa-plus fa-sm"></i> Tambah Supplier</h3>
                    ...
                    <div class="row">
                        ...
                        <?php if ($alert != '') {
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama" class="form-control" id="nama" placeholder="Masukkan nama supplier" autofocus aoutocomplete="off" required>
                            </div>
                            <div class="form-group">
                                <label for="telpon">Telepon</label>
                                <input type="text" name="telpon" class="form-control" id="telpon" placeholder="Masukkan nomor telepon supplier" pattern="[0-9]{5,}" title="Minimal 5 angka" required>
                            </div>
                            <div class="form-group">

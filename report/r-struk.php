...
<body>
    ...
    <table style="border-bottom: dotted 2px; font-size: 14px; width: 240px;">
        ...
        ?>
            ...
            <tr>
                <td colspan="2" style="width: 70px;">Jumlah: </td>
                ...
                <td colspan="2" style="width: 70px; text-align: right;"><?= number_format($item['jml_harga'],0,',','.') ?></td>
            </tr>
        <?php }
        ?>
    </table>
    ...
    <table style="text-align:center; margin-top: 5px; font-size: 14px; width: 240px;">
        <tr>
            <td>Terima kasih sudah berbelaja</td>
        </tr>
    </table>

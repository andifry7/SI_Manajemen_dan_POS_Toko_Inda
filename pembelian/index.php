                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="form-group">
                                <input type="hidden" value="<?= @$_GET['pilihbrg'] ? $selectBrg['id_barang'] : '' ?>" name="kodeBrg" id="kodeBrg">
                        ...
                        <div class="col-lg-1">
                            <div class="form-group">
                                ...
                                <input type="text" name="kategori" class="form-control form-control-sm" id="kategori" value="<?= @$_GET['pilihbrg'] ? $selectBrg['kategori'] : '' ?>"readonly>
                            </div>
                        </div>
                        <div class="col-lg-1">
                            <div class="form-group">
                            ...
                            foreach ($brgDetail as $detail) { ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="?idbrg=<?= $detail['kode_brg'] ?>&idbeli=<?= $detail['no_beli'] ?> &qty=<?= $detail['qty'] ?>&tgl=<?= $detail['tgl_beli'] ?>&msg=deleted" class="btn btn-danger btn-sm" title="hapus barang" onclick="return confirm('Anda yakin ingin menghapus barang ini?')"><i class="fas fa-trash"></i></a>
                                    </td>
                                </tr>
                            <?php
                            }

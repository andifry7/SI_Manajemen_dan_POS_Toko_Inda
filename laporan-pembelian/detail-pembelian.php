        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?= $main_url ?>laporan-pembelian/index.php">Laporan Pembelian</a></li>
                        ...
                        <tbody>
                            ...
                            foreach ($pembelian as $beli) { ?>
                                <tr>
                                    ...
                                    <td><?= $beli['nama_brg'] ?></td>
                                    <td><?= $beli['kategori'] ?></td>
                                    <td class="text-right"><?= number_format($beli['harga_beli'], 0, ',', '.') ?></td>
                                    <td class="text-center"><?= $beli['qty'] ?></td>
                                    <td class="text-right"><?= number_format($beli['jml_harga'], 0, ',', '.') ?></td>
                                </tr>
                            <?php
                            }
                            ?>

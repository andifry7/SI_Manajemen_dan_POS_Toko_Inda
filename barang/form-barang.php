                    ...
                    <div class="row">
                        <div class="col-lg-8 mb-3 pr-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="kode" value="<?= generateId() ?>" class="form-control" id="kode" readonly>
                            </div>
                            <div class="form-group">
                                <label for="barcode">Barcode *</label>
                                <input type="text" name="barcode" class="form-control" id="barcode" placeholder="Masukkan barcode barang" autofocus autocomplete="off" required>
                            </div>
                            <div class="form-group">
                                <label for="name">Nama Barang *</label>
                                <input type="text" name="name" class="form-control" id="name" placeholder="Masukkan nama barang" autofocus autocomplete="off" required>
                            </div>
                            <div class="form-group">
